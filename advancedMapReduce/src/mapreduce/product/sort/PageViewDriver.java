...
public class PageViewDriver extends Configured implements Tool{
	...
	public int run(String[] optionlist) throws Exception {
		...
		job.setMapperClass(PageViewMapper_version2.class);
		job.setReducerClass(PageViewReducer_version2.class);
		job.setJarByClass(PageViewDriver.class);
		
		job.setPartitionerClass(MyKeyPartitioner_version2.class);
